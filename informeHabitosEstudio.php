<?php
	...
	$numeroControl = $_SESSION['listaDI'];
  ...
  <div id="contenedor">
    ...
    <div id="areat">
      ...
      <div id="marcoSesion">
		...
		<a href='listaHabitosEstudio.php?$idSesion'>Lista alumnos</a>
		&nbsp;&nbsp;&nbsp;&nbsp;
	...
	// Consulta SQL
	$conexion->query = 'SELECT * FROM respuestas,nombres where respuestas.num_Control=\''.$numeroControl.'\' && nombres.numControl=\''.$numeroControl.'\'';
	$conexion->consultaSQL();
  	$cont=0;
           ...
           <table width='100%' border='0'>
              <tr>
                <td colspan='2'><table width='100%' border='0'>
                    <tr>
                      <td colspan='3'><div align='center'><h3 class='Estilo1'>Reporte Personal de H&aacute;bitos de Estudio</h3>
                          <p>&nbsp;</p>
                          </strong></div></td>
                    </tr>
                    <tr>
                      <td colspan='3'><div align='center'><img src='fotos/";
			if(strlen($numeroControl) == 7){
		echo "0$numeroControl";
		}
		else{
		echo "$numeroControl";
		}
echo".jpg' width='100' height='120' />
                          <p></p>
                        </div></td>
                    </tr>
                    <tr>
                      <td colspan='3' align='center'>Nombre: $nombre</td>
                    </tr>
                    <tr>
                      <td colspan='3' align='center'>No. Control: $numeroControl</td>			
			</tr>
			</table>
			</td>
			</tr>
...
echo "
	...
	contexto.stroke();
            ...
            <h3>Cuestionario de auto evaluaci&oacute;n de h&aacute;bitos de estudio</h3>
            <p>&nbsp;</p>
            ...
            <h5>
              <label>
                <input type='radio' name='radio66' id='s' value='0' disabled "; if($r66==0)echo " checked"; echo"/>
                S</label>
              <label>
                <input type='radio' name='radio66' id='a' value='1' disabled "; if($r66==1)echo " checked"; echo"/>
                A </label>
              <label>
                <input type='radio' name='radio66' id='r' value='2' disabled "; if($r66==2)echo " checked"; echo"/>
                R </label>
              <label>
                <input type='radio' name='radio66' id='n' value='3' disabled "; if($r66==3)echo " checked"; echo"/>
                N </label>
            </h5>
